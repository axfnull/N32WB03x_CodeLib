...
1. Function description
    ...
    Bluetooth BLE data transmission service (rdts) master example, using 128bit UUID. After connecting the slave device, 
    the data received by Bluetooth will be transparently transmitted to USART1, and the data received by USART1 will 
    be transparently transmitted to the slave device
