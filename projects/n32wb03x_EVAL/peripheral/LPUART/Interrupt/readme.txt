...
1. Function description
    ...
    USARTz can be USART2. LPUART sends TxBuffer1 data to USARTz, and USARTz receives data to RxBuffer2. 
    At the same time, USARTz sends TxBuffer2 data to LPUART, and LPUART receives data to RxBuffer1.
