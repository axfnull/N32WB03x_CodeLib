...
1. Function description
    ...
    Bluetooth BLE blood pressure service routine. After the BLE host connects to the device, 
    the chip automatically generates heart rate data and reports it through the Bluetooth blood pressure service.
...
3. Instructions
    ...
    System configuration;
        ...
        4. Bluetooth BLE name: NS_ Blood_ Pressuse
        5. LED1 lights up when it is turned on, LED2 indicates the connection status, and lights up when Bluetooth is connected
        6. After Bluetooth connection, the blood pressure data will be reported every second.    
