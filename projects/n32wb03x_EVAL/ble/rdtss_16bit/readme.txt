1. Function description
    ...
    Bluetooth BLE data transmission service (rdts) routine, using 16bit UUID. After the BLE host connects to the device,
    the downtream data will be transparently transmitted to USART1, and the data received by USART1 will be transparently transmitted to the BLE host
